 ...
 * 
 */
public class ViewPagerActivity extends ZYActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent i1 = new Intent(context, T1Activity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		listViews.add(getView("T1Activity", i1));
		Intent i2 = new Intent(context, T2Activity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
