...
public class Xinwen2Activity extends Activity{
	TextView  empty_txt;
	...
	private void showHistory() {		 
	      ...
	      adpater=new SimpleCursorAdapter(this
	       ...
	       list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					...
					intent.setClass(Xinwen2Activity.this, XinwenShowActivity.class);
	 ...
	 private void ItemOnLongClick1() {
        ...
        public boolean onContextItemSelected(MenuItem item) {
                ...
                case 0:
                	//删除一条记录   	                	 
                	 db.delRecord(String.valueOf(info.id),"4");
	   				 Toast.makeText(Xinwen2Activity.this, "该记录删除成功！", Toast.LENGTH_SHORT).show();
	   				 showHistory();
                  break; 
                case 1:
                   // 删除ALL操作
                	 db.delHistory("4");
	   				 Toast.makeText(Xinwen2Activity.this, "所有记录删除成功！", Toast.LENGTH_SHORT).show();
	   				 showHistory();
                   break; 
                case 2:
                	//取消操作
