...
public class AppUpdateService extends Service {
	...
	private long mDownloadSize = 0;//已下载大小
	private long mLength;//文件总大小
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		// 设置任务栏中下载进程显示的views
		views = new RemoteViews(getPackageName(), R.layout.down_noti_layout);
				...
				try {
					...
					if (is != null) {
						...
						while ((read = bis.read(buffer)) != -1 && !cancelUpdate) {
							...
							mDownloadSize += read;
							precent = (int) (((double) mDownloadSize / mLength) * 100);
		...
		public void handleMessage(Message msg) {
			...
			if (msg != null) {
				...
				case 3:					
					String str = "已下载"
					+ download_precent + "%("
					+ FileUtil.getSoftwareSize(mDownloadSize)
					+ "/"
					+ FileUtil.getSoftwareSize(mLength)
					+ ")";
					// 更新状态栏上的下载进度信息
					views.setTextViewText(R.id.offline_down_text, str);
					views.setProgressBar(R.id.offline_down_pb, 100,
